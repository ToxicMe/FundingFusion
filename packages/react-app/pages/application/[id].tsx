...
const GrantApplication = () => {
  ...
  const handleAmountSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const Amount = Number(data.amount) * 10 ** 18 || 0;
    ...
    try {
      ...
      if (paid) {
        const hash = await writeContractAsync({
          ...
          args: [BigInt(Number(id)), BigInt(Amount)],
        });
        if (hash) {
          console.log(hash);
          setIsFormVisible(false);
            ...
            <div className="flow-root rounded-lg border border-gray-100 py-6 shadow-sm">
              <dl className="-my-3 divide-y divide-gray-100 text-sm">
                <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                  <dt className="font-medium text-gray-900">Project Title</dt>
                ...
                <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                  <dt className="font-medium text-gray-900">Introduction</dt>
                  <dd className="text-gray-700 sm:col-span-2">
                ...
                <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                  <dt className="font-medium text-gray-900">Demo link</dt>
                  <dd className="text-gray-700 sm:col-span-2">
                ...
                <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                  <dt className="font-medium text-gray-900">Live link</dt>
                  <dd className="text-gray-700 sm:col-span-2">
                ...
                <div className="relative bg-white p-4 rounded-lg shadow-md w-80">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <small className="text-black">
                      <span className="italic">NB:</span> The amount will be
                      sent to the applicant in cUSD.
                    </small>
